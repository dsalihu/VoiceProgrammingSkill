...
sheet_url = "https://docs.google.com/spreadsheets/d/15ZsXiUPpKHdZeLCNAoBdfGvVJCED7M9b0494KfALS0o"
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        cell_value = worksheet.get('D1')[0][0]
...
sb.add_request_handler(GoogleSheetsIntentHandler())
